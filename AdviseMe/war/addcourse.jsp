...
<html>
  ...
  <%
	...
	if(schools.isEmpty()){
	...
	}else if(schools.get(0).getCollegeList().get(0).getDepartmentList().isEmpty()){//TODO: need to figure out how to first select school, then populate college list.
		...
		<%			
		for(Department department: schools.get(0).getCollegeList().get(0).getDepartmentList()){
			pageContext.setAttribute("department_name",department.getName());
		%>
		...
		<h3>Course Name:</h3>
      	<div><textarea name="coursename" rows="1" cols="30"></textarea></div>
